...
export const dictionaries = {
  en: {
    ...
    "privacy.p2": "All deep analytics like word and sentences, topic detection, and emojis are computed entirely offline. If you opt-in to the AI analysis feature, your browser communicates directly with Google's Gemini API. If spotify links found, only public track IDs are sent to a serverless function to fetch album art.",
    "privacy.p3": "",
    "privacy.chooseLanguage": "Choose your language:",
    "privacy.tech.title": "Technical details",
    "privacy.tech.1": "→ NLP parser runs 100% locally in-browser via Vite/React SPA",
    "privacy.tech.2": "→ All metrics (topics, stats, insight) generated offline",
    "privacy.tech.3": "→ Optional AI payload: only aggregated stats + 8 random excerpts",
    "privacy.tech.4": "→ No cookies, no tracking, no databases.",
    ...
    "group.iconChanged": "Group icon changed {count} times",
    "group.renamed": "Renamed {count} times",
    "group.changedTo": "changed to",
    "group.from": "from",
  ...
  id: {
    ...
    "upload.drag_active": "Jatuhkan untuk menganalisis",
    "upload.click_browse": "klik untuk menelusuri",
    ...
    "privacy.p2": "Semua analitik mendalam seperti pelacakan pola kata dan kalimat, deteksi topik, dan emoji dihitung sepenuhnya secara offline. Jika Anda menggunakan fitur analisa AI, browser Anda berkomunikasi langsung dengan Google Gemini API. Jika tautan spotify ditemukan, hanya ID track publik yang dikirim ke serverless backend untuk mengambil cover album.",
    "privacy.p3": "",
    "privacy.chooseLanguage": "Pilih bahasa Anda:",
    "privacy.tech.title": "Detail teknis",
    "privacy.tech.1": "→ Parser NLP berjalan 100% lokal di browser melalui Vite/React SPA",
    "privacy.tech.2": "→ Semua metrik (topik, perhitungan, dan insight) dihasilkan offline",
    "privacy.tech.3": "→ Payload AI (Opsional): hanya statistik agregat + 8 cuplikan acak",
    "privacy.tech.4": "→ Tanpa cookies, tanpa pelacakan, tanpa database.",
    ...
    "group.showingTop": "Menampilkan 10 pengirim teraktif",
    "group.showingTop10": "Menampilkan 10 teratas",
    "group.iconChanged": "Ikon grup diubah {count} kali",
    "group.renamed": "Dinamai ulang {count} kali",
    "group.changedTo": "mengubah menjadi",
    "group.from": "dari",
