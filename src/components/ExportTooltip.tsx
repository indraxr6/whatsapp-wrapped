...
export default function ExportTooltip() {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-[220px] bg-white border-2 border-black shadow-[4px_4px_0_0_#000] p-2 z-50 pointer-events-none">
          <div className="relative w-full aspect-[9/19.5] bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-200">
